...
//
// import {sleep, toCamelCase} from "./util";
//
...
//
// ipcRendererMock.fake('get-installed', async () => {
//     return JSON.parse(JSON.stringify(dummyInstalled), toCamelCase);
// });
//
// ipcRendererMock.fake('winget-task', async (sentTask: ITask) => {
//     const task = {
//         ...taskFailed,
//         // ...taskSuccess,
//         id: sentTask.id,
